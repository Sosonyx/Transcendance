...
import { registerFriendChat } from './friend/friendsChat.js'; // <-- ajuste le chemin
import { prisma } from './prisma/prisma.js'; // <-- d'où vient ton client Prisma
